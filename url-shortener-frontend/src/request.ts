const sendUrl: HTMLButtonElement = document.getElementById(
	"urlBtn"
) as HTMLButtonElement;
const urlInput: HTMLInputElement = document.getElementById(
	"userUrl"
) as HTMLInputElement;
const urlShort: HTMLInputElement = document.getElementById(
	"urlShort"
) as HTMLInputElement;
const urlCopy: HTMLSpanElement = document.getElementById(
	"urlCopy"
) as HTMLSpanElement;
